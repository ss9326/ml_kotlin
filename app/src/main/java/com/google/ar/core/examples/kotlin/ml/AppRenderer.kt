...
import com.google.ar.core.examples.kotlin.ml.classification.MLKitSegmenter
import com.google.ar.core.examples.kotlin.ml.classification.SegmentationGraphic
...
class AppRenderer(val activity: MainActivity) : DefaultLifecycleObserver, SampleRender.Renderer {
  ...
  val mlKitSegmenter = MLKitSegmenter(activity)
  ...
  var currentAnalyzer = mlKitSegmenter
  ...
  override fun onSurfaceCreated(render: SampleRender) {
    ...
    view.overlayView.setImageSourceInfo(render.viewportWidth, render.viewportHeight, true)
  }
  ...
  override fun onDrawFrame(render: SampleRender) {
    ...
    if (scanButtonWasPressed || true) {
      ...
      if (cameraImage != null) {
        ...
        coroutineScope.launch(Dispatchers.IO) {
          ...
          segmentationMask =
            try {
              val result = currentAnalyzer.analyze(cameraImage, imageRotation)
              result
    ...
    val seg = segmentationMask
    if (seg != null) {
      segmentationMask = null
      val graphicOverlay = view.overlayView
      graphicOverlay.clear()
      graphicOverlay.add(SegmentationGraphic(graphicOverlay, seg))
